  ...
  return (
    <>
      ...
      <span
        role="status"
        className={cx(
          "@container-[size] relative inline-flex aspect-9/4 items-center justify-center align-middle [--eye-color:color-mix(in_srgb,currentColor_14%,transparent)] [--pupil-color:currentColor]",
          className,
        )}
        style={eyesStyle}
        {...props}
