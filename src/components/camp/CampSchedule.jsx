function CapmSchedule() {
	return (
		<div className="flex flex-col w-full h-auto items-center justify-center py-[146px] lg:px-[425px] gap-15">
			...
			<div className="flex flex-col lg:flex-row items-center justify-center w-full h-auto box-border border-[#F7347E] text-[#F7347E]">
				<div className="flex flex-col items-center justify-center rounded-full w-37 h-37 border-3">
				...
				<div className="flex flex-col items-center justify-center rounded-full w-37 h-37 border-3 bg-[#F7347E]">
